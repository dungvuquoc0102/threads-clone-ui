  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          {t(dataMap[isRouting])}
          <span className="flex size-6 cursor-pointer items-center justify-center rounded-[50%] border-2 border-gray-300 shadow shadow-gray-300 hover:scale-110">
            <ChevronDown className="size-5" />
          </span>
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent className="flex w-56 flex-col gap-1">
        <DropdownMenuLabel
        ...
        >
          Ghost posts
          <span>
            <svg role="img" viewBox="0 0 20 20" className="size-5">
              <title></title>
